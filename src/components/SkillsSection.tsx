  ...
  const SkillBar = ({
    ...
    >
      <div className="flex justify-between items-center">
        <span className="text-sm tracking-wider text-foreground/90">
          {skill.name}
        </span>
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            With 3 years of experience, I've developed proficiency in modern
            frontend technologies and design tools to create exceptional web
            experiences.
          </motion.p>
        </motion.div>
